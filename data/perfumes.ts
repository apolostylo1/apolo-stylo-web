...
},
{
  ...
  categoria: "Árabe",
  marca: "Rasasi",
  descripcion: "Fresco, acuático y ligeramente dulce, con un fondo amaderado y almizclado.",
  notas: ["Manzana", "Limón", "Canela", "Bergamota", "Ciruela", "Cardamomo", "Almizcle", "Ámbar", "Maderas"],
  stock: true,
  precio: 75000,
...
},
{
  ...
  categoria: "Árabe",
  marca: "Rasasi",
  descripcion: "Tropical, frutal y fresco, con un carácter dulce y vibrante.",
  notas: ["Piña", "Maracuyá", "Coco", "Limón", "Jazmín", "Almizcle", "Ámbar"],
  stock: true,
  precio: 70000,
  imagen: "/perfumes/hawas-tropical.jpg",
},
